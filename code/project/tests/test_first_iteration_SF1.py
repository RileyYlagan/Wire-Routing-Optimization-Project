...
outside_points = np.loadtxt("points_SF1.txt", dtype=float)
...
with open('node_dic_SF1.txt', 'w') as fp:
...
start, goal = alg.start_and_end(node_dic,p1,p2)
route = alg.get_route(start,goal,node_dic)
alg.save_path_to_STL(route,"new_test_Wire1_SF1")

p1 = random.randint(0,len(node_dic)-1)
p2 = random.randint(0,len(node_dic)-1)
start, goal = alg.start_and_end(node_dic,p1,p2)
route = alg.get_route(start,goal,node_dic)
alg.save_path_to_STL(route,"new_test_Wire2_SF1")

p1 = random.randint(0,len(node_dic)-1)
p2 = random.randint(0,len(node_dic)-1)
start, goal = alg.start_and_end(node_dic,p1,p2)
route = alg.get_route(start,goal,node_dic)
alg.save_path_to_STL(route,"new_test_Wire3_SF1")
